...
-- sound effects
local correctSound = audio.loadStream("Sounds/yay.mp3")
...
local function CheckUserAnswerInput()
    ...
    if (userAnswer == correctAnswer) then
        ...
        -- if the player has 3 question correct, go to the winning screen after half a second's delay
        if (questionsCorrect == 3) then
    ...
    -- otherwise:
        ...
        -- take away from the user's life count
        LIVES = LIVES -1   
